    ...
    $(function() {
        ...
        $('#archive-form').submit(function(e) {
            ...
            if ($('#abstract').is(':hidden')) {
                $('#abstract').removeAttr('required');
            }
            if ($('#members').is(':hidden')) {
                $('#members').removeAttr('required');
            }
            ...
            $.ajax({
                ...
                error: function(err) {
                    ...
                    el.text("An error occurred while saving the data: " + err.statusText);
                ...
                success: function(resp) {
                    console.log(resp); // Add this to see the full response

                    if (resp.status == 'success') {
                        location.href = "./?page=view_research&id=" + resp.id;
                    } else if (resp.msg) {
                        el.text(resp.msg);
                        el.addClass("alert-danger");
                        _this.prepend(el);
