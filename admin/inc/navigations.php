...
<head>
    ...
    <link href="distt/css/adminlte.css" rel="stylesheet">
        ...
        <div class="btn-group">
            <a href="#" 
               ...
               style="border-radius: 25px; padding: 5px 15px;">
                ...
                <!-- Name -->
                <sp class="fw-bold text-dark" style="font-size: 0.9rem;"><?php echo ucwords($_settings->userdata('firstname') . ' ' . $_settings->userdata('lastname')) ?></span>
            </a>
