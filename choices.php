    ...
    <div class="container position-absolute top-50 start-50 translate-middle">
        <div class="row justify-content-center align-items-center">
            ...
            <img src="uploads/LitLogo.png" alt="PUP Logo" class="mb-4 img-fluid" style="max-width: 200px;">
                ...
                <a href="./admin" class="btn btn-danger btn-lg mb-3 w-100" style="background-color: #810100; color: white;">Faculty</a>
                
                <p class="mt-3"><a href="#" class="text-decoration-none">Terms and Conditions</a></p>
            </div>
        </div>
    </div>
